...
await sock.sendMessage(target, { 
    albumMessage: [
        { image: cihuy, caption: "#HANZPIW" },
        { image: { url: "URL IMAGE" }, caption: "#HANZPIW" }
    ] 
}, { quoted: m });
```
...
await sock.sendMessage(target, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/HANZPIW2", 
...
await sock.sendMessage(target, {
    interactiveMessage: {
        header: "#HANZPIW",
        title: "#HANZPIW",
        footer: "telegram: @HANZPIW2 ",
        buttons: [
            {
                name: "cta_copy",
                buttonParamsJson: JSON.stringify({
                    display_text: "#HANZPIW",
                    id: "123456789",              
                    copy_code: "ABC123XYZ"
                })
            }
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                bottom_sheet: {            
                    ...
                    list_title: "#HANZPIW",            
                    button_title: "#HANZPIW"          
                },          
                tap_target_configuration: {            
                    title: " X ",            
                    description: "bomboclard",            
                    canonical_url: "https://t.me/HANZPIW2",            
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/HANZPIW2",
                    merchant_url: "https://t.me/HANZPIW2"
                })
            }
        ]
    }
